...
// export const BASE_URL = `${document.location.protocol}//api.kotezh.diploma.nomoredomains.monster`;
...
export const PATTERN_PASSWORD_ERROR_TEXT = "Строчные и прописные латинские буквы, цифры. Минимум 8 символов.";
...
export const MAGIC_ERROR_TEXT = 'При выполнении запроса произошла непредвиденная ошибка';
export const NOT_FOUND_ERROR_TEXT = "Ничего не найдено";
export const KEYWORD_ERROR_TEXT = "Нужно ввести ключевое слово";

export const SAVE_MOVIE_ERROR_TEXT = "При сохранении фильма произошла ошибка";
export const DELETE_MOVIE_ERROR_TEXT = "При удалении фильма произошла ошибка";
export const SUCCESS_TEXT = "Данные успешно обновлены";
